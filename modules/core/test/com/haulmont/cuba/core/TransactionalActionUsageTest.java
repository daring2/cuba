...
public class TransactionalActionUsageTest {
    ...
    public void testBeforeCommitAction() {
        EntitySet entities = transactionalActionFactory
                ...
                .beforeCommit(cc -> cc.getCommitInstances().stream()
        ...
        assertEquals("newName", productFromDb.getName());
    }
    ...
    public void testAllActions() {
        EntitySet entities = transactionalDataManager
                ...
                .beforeCommit(cc -> cc.getCommitInstances().stream()
                        .filter(e -> Product.class.equals(e.getMetaClass().getJavaClass()))
                        .forEach(e -> ((Product) e).setName("newNameAllActionsTest")))
                .onSuccess(es -> {
                    es.stream()
                            .filter(e -> Product.class.equals(e.getMetaClass().getJavaClass()))
        ...
        assertNotNull(productFromDb);
        assertEquals("newNameAllActionsTest", productFromDb.getName());
