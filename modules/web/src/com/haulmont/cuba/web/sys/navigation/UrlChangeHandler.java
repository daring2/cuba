...
public class UrlChangeHandler implements InitializingBean {
    ...
    public boolean isEmptyState(NavigationState requestedState) {
        return requestedState == null || requestedState == NavigationState.EMPTY;
    }

    public boolean isRootRoute(WindowInfo windowInfo) {
    ...
    public boolean isNotPermittedToNavigate(NavigationState requestedState, WindowInfo windowInfo) {
